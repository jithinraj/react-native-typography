...
// has many steps defined for some dense languages, Noto Sans CJK only has
// regular and bold available by default

// San Francisco falls back from regular to bold starting from semibold for the scripts
// for which it doesn't have so many weight steps, so let's do the same here.
